...
const AnimatedRoutes = () => {
  ...
  return (
    <AnimatePresence mode="popLayout">
      <Suspense fallback={
        <div className="min-h-[80vh] flex flex-col items-center justify-center gap-6 bg-slate-950/20 backdrop-blur-md transition-all duration-500">
        ...
        <motion.div
          ...
          initial={{ opacity: 0, scale: 0.99, translateY: 10 }}
          animate={{ opacity: 1, scale: 1, translateY: 0 }}
          exit={{ opacity: 0, scale: 1.01, translateY: -10 }}
          transition={{ 
            duration: 0.5,
            ease: [0.16, 1, 0.3, 1] 
          }}
